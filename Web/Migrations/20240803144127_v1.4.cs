...
namespace Web.Migrations
{
 ...
 SELECT ""UserExam"".""Id"",
  ...
  GROUP BY ""UserExam"".""Id"", ""AspNetUsers"".""NamaLengkap"", ""AspNetUsers"".""Gender"", ""AspNetUsers"".""PhoneNumber"", ""Kota"".""NamaKota"", ""Room"".""Nama"", ""Room"".""JadwalStart"", ""AspNetUsers"".""Id""
  ORDER BY ""AspNetUsers"".""NamaLengkap""
            ");
        }
